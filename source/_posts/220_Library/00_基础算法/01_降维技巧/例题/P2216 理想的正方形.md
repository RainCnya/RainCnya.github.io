...
updated2: 2026-2-21 19:05:44
---
# [P2216 [HAOI2007] 理想的正方形 - 洛谷](https://www.luogu.com.cn/problem/P2216)
## 1. 题面梗概

**中译中**：有一个 $a \times b$ 的整数组成的矩阵，现请从中找出一个 $n \times n$ 的小正方形，使得该区域内的最大值和最小值的差最小。

> $2 \leq a, b \leq 10^3, n \leq a, n \leq b, n \leq 100$
...
- **碎碎念**: 这种 **先行后列** 的降维思想在处理矩阵区域最值的时候很有用。
        
- **关联笔记**: [[01_降维技巧#单调队列 | 单调队列]]